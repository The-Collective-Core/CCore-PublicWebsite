...
$( function() {
    ...
    $( "#draggable-JS-03" ).draggable({ containment: "body", scroll: false , grid: [ 20, 20 ] });
    $( "#draggable-JS-04" ).draggable({ containment: "body", scroll: false , grid: [ 20, 20 ] });
    $( "#draggable-JS-05" ).draggable({ containment: "body", scroll: false , grid: [ 20, 20 ] });
  } );
