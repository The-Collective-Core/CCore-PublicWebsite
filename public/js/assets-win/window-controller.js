...
function initAppController() {
	...
	appController.add({
		...
		onOpen: () => {},
		onClose: () => {},
		iconPath: "/img/images/vector-img/desktop/branches/LG.gif",
		iconName: "LOGISTICS",
	...
	appController.add({
		...
		onOpen: () => {},
		onClose: () => {},
		iconPath: "/img/images/vector-img/desktop/branches/RD.gif",
		iconName: "SCIENCE",
		iconXDelta: 75,
		iconParent: "sub-folder-0",
	...
	appController.add({
		...
		onOpen: () => {},
		onClose: () => {},
		iconPath: "/img/images/vector-img/desktop/branches/TC.gif",
		iconName: "TACTICAL",
		iconParent: "sub-folder-0",
		iconXDelta: 75,
	...
	appController.add({
		...
		onOpen: () => {},
		onClose: () => {},
		iconPath: "/img/images/vector-img/desktop/branches/DP.gif",
		iconName: "DIPLOMACY",
		iconParent: "sub-folder-0",
		iconXDelta: 75,
