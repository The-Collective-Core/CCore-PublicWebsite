	...
	var view = {
	  ...
	  scrollPage: function scrollPage(direction) {
		...
		if (this.isScrolling === false) {
		  ...
		  direction =
			$.isNumeric(direction) && Math.abs(direction) === 1 ? direction : 1;
	...
	var controller = {
	  ...
	  getFeedArticles: function getFeedArticles(json) {
		...
		try {
		  ...
		  out =
			"Error: Invalid feed. Please use a valid url.<br><i>(" + e + ")</i>";
		}
		return out;
	  },
